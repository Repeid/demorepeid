  ...
  function ($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
      ...
      .state('persona.app.administracion.documento.buscar', {
        url: '/buscar',
        templateUrl: 'modules/persona/views/tipoDocumento/form-buscar.html',
      ...
      .state('persona.app.administracion.documento.crear', {
        url: '/crear',
        templateUrl: 'modules/persona/views/tipoDocumento/form-crear.html',
      ...
      .state('persona.app.administracion.documento.editar', {
        ...
        templateUrl: 'modules/persona/views/tipoDocumento/form-editar.html',
        resolve: {
      ...
      .state('persona.app.persona.natural.buscar', {
        url: '/buscar',
        templateUrl: 'modules/persona/views/natural/form-buscar.html',
      ...
      templateUrl: 'modules/persona/views/natural/form-crear.html',
      ...
      templateUrl: 'modules/persona/views/natural/form-editar.html',
      resolve: {
      ...
      .state('persona.app.persona.juridica.buscar', {
        url: '/buscar',
        templateUrl: 'modules/persona/views/juridica/form-buscar.html',
      ...
      url: '/crear?tipoDocumento&numeroDocumento',
      templateUrl: 'modules/persona/views/juridica/form-crear.html',
      ...
      .state('persona.app.persona.juridica.editar', {
        ...
        templateUrl: 'modules/persona/views/juridica/form-editar.html',
        resolve: {
